...
```javascript
FLOAT64_MIN_LN = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-ln@v0.2.3-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/constants-float64-min-ln@v0.2.3-umd/browser.js"></script>
```
